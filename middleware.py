...
def consultar_cep():
    ...
    # Adiciona o Guid (pode ser gerado dinamicamente ou usar o mesmo do XML recebido)
    guid = ET.SubElement(return_value, 'Guid')
    guid.text = str(uuid.uuid4())  # Gera um novo GUID
